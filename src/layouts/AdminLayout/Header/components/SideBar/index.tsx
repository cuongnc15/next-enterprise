...
const sideBarItems = [
  ...
  {
    label: 'Gói ứng viên',
    pathName: '/goi-ung-vien',
    children: [
      {
        icon: SrcIcons.user,
        label: 'Hồ sơ ứng viên',
        pathName: '/goi-ung-vien/ho-so-ung-vien',
      },
      {
        icon: SrcIcons.hoso,
        label: 'Hồ sơ đã xem chi tiết',
        pathName: '/goi-ung-vien/ho-so-da-xem-chi-tiet',
      },
      {
        icon: SrcIcons.bookmark,
        label: 'Hồ sơ đã tiếp nhận',
        pathName: '/goi-ung-vien/ho-so-da-tiep-nhan',
      },
    ],
  },
  ...
  },
  {
    ...
    pathName: `${process.env.NEXT_PUBLIC_APP_URL}/privacy-intro`,
  },
  {
    label: 'Liên hệ',
    icon: SrcIcons.contact,

    pathName: `${process.env.NEXT_PUBLIC_APP_URL}/privacy-contact`,
  },
  {
    label: 'Điều khoản',
    icon: SrcIcons.note,

    pathName: `${process.env.NEXT_PUBLIC_APP_URL}/privacy-note`,
  },
  {
    label: 'Cộng đồng',
    icon: SrcIcons.comu,
    pathName: `${process.env.NEXT_PUBLIC_APP_URL}/privacy-comu`,
  },
];
